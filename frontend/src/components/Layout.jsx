  ...
  return (
    <div style={{ display:'flex', minHeight:'100vh', background:'var(--bg)' }}>
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', marginLeft: collapsed ? 'var(--sidebar-w-c)' : 'var(--sidebar-w)', transition:'margin-left .22s cubic-bezier(.4,0,.2,1)', minWidth:0 }}>
        ...
        {/* Topbar */}
        <header style={{ height:'var(--topbar-h)', background:'var(--topbar-bg)', borderBottom:'1px solid var(--border)', display:'flex', alignItems:'center', padding:'0 24px', gap:12, position:'sticky', top:0, zIndex:90, boxShadow:'0 1px 3px rgba(0,0,0,0.04)' }}>
